                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3 ">
                                    <div class="mb-lg-0">
                                        <label for="projectDescriptionTextarea" class="form-label">Project's
                                            Description</label>
                                ...
                                <div class="col-lg-6 mb-3 ">
                                    <div class="mb-lg-0">
                                        <label for="openingCashinHand" class="form-label">Opening Cash in Hand <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="openingCashinHand"
                                            name="openingCashinHand" placeholder="Enter opening cash in hand">
